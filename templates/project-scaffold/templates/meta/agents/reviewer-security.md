...
Canonical KIT skeleton lifted from 42Bros + Example reviewers; project-specific audit domains and checks go in the `## Project Extensions` section at the bottom.
